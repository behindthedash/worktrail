# dashboard-selfcheck-spec-folder-scope Specification

## Purpose
TBD - created by archiving change dashboard-selfcheck-skip-non-spec-dirs. Update Purpose after archive.
## Requirements
