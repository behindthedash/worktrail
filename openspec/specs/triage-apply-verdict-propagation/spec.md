# triage-apply-verdict-propagation Specification

## Purpose
TBD - created by archiving change triage-apply-propagate-verdict-into-brief-body. Update Purpose after archive.
## Requirements
