...
Pre-orchestration validation of same-spec task dependencies and (devkit-only)
decision-log dependency coverage, surfaced through `worktrail-live precheck`
with actionable, per-task diagnostics instead of a silent orchestration
stall.
