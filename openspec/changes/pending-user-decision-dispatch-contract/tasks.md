...
- [ ] 2.1 Convert collision, staleness, and related-brief guard outputs to the provider-neutral envelope in `src/worktrail/router/check_spec_collision.py`, `src/worktrail/router/check_brief_staleness.py`, `src/worktrail/router/check_related_brief_claims.py`, and their corresponding `tests/router/test_check_spec_collision.py`, `tests/router/test_check_brief_staleness.py`, and `tests/router/test_check_related_brief_claims.py` suites.
  files: src/worktrail/router/check_spec_collision.py, src/worktrail/router/check_brief_staleness.py, src/worktrail/router/check_related_brief_claims.py, tests/router/test_check_spec_collision.py, tests/router/test_check_brief_staleness.py, tests/router/test_check_related_brief_claims.py
...
- [ ] 4.1 Update the canonical guard/prompt/resume procedures in `skills/worktrail-go/SKILL.md`, `skills/worktrail-go/references/spec-collision-check.md`, `skills/worktrail-go/references/brief-staleness-check.md`, `skills/worktrail-go/references/related-brief-collision-check.md`, `skills/worktrail-go/references/decision-queue.md`, and `skills/worktrail-go/references/subagent-prompts.md`; enforce the cross-surface contract in `tests/test_plugin_surface.py` without changing `openspec/specs/human-decision-queue/spec.md`. (Requirement: Decision lifecycle is auditable across dispatch modes)
  files: skills/worktrail-go/SKILL.md, skills/worktrail-go/references/spec-collision-check.md, skills/worktrail-go/references/brief-staleness-check.md, skills/worktrail-go/references/related-brief-collision-check.md, skills/worktrail-go/references/decision-queue.md, skills/worktrail-go/references/subagent-prompts.md, tests/test_plugin_surface.py
- [ ] 4.2 [e2e] Run `PYTHONPATH=src pytest -q` and `PYTHONPATH=src python3 -m worktrail.orchestrator.orchestrate check`, confirming the provider/dispatch-mode matrix and the existing human-decision-queue contract remain green.
