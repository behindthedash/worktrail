...
- [ ] 1.1 Create `src/worktrail/router/check_brief_staleness.py`. Module docstring follows
...
- [ ] 1.2 Add the `gh` lookup to `src/worktrail/router/check_brief_staleness.py` as an
...
- [ ] 1.3 Add the `main(argv)` CLI to `src/worktrail/router/check_brief_staleness.py` mirroring
...
- [ ] 1.4 Register `worktrail-check-brief-staleness =
...
- [ ] 2.1 Create `tests/router/test_check_brief_staleness.py` covering extraction against every
...
- [ ] 2.2 Extend `tests/router/test_check_brief_staleness.py` with history-search coverage using
...
- [ ] 2.3 Extend `tests/router/test_check_brief_staleness.py` with fail-open coverage: non-git
...
- [ ] 2.4 Add a `TestCli` class to `tests/router/test_check_brief_staleness.py` following
...
- [ ] 3.1 Update `skills/worktrail-go/SKILL.md` Phase 5.5 so it describes one question asked two
...
- [ ] 3.2 Create `skills/worktrail-go/references/brief-staleness-check.md` with the full
