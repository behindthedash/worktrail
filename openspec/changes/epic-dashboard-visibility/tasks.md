...
- [x] 1.1 In `src/worktrail/router/dashboard.py`, add the epic-id filename pattern, terminal-status
...
- [x] 1.2 In `src/worktrail/router/dashboard.py`, add a sibling scan entry point that lists
...
- [x] 2.1 In `src/worktrail/router/dashboard.py`'s `main()`, call the 1.2 scan for both the
