...
- [x] 1.1 Create `src/worktrail/router/check_related_brief_claims.py`: a
...
- [x] 1.2 In the same module, add best-effort local run-record enrichment:
...
- [x] 1.3 Add a CLI (`main(argv)`, `if __name__ == "__main__"`) mirroring
...
- [x] 2.1 Add `worktrail-check-related-brief-claims =
...
- [x] 3.1 Create `tests/router/test_check_related_brief_claims.py`
...
- [x] 4.1 Add a new `{#related-brief-collision-check}` reference section to
...
- [x] 4.2 Edit `skills/worktrail-go/SKILL.md`'s Phase 5.5 section: add a
...
- [x] 5.2 [e2e] Run `pytest tests/test_plugin_surface.py` -- confirms the new
