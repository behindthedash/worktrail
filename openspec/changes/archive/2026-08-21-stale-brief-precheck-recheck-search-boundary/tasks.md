...
- [x] 1.1 In `check_brief_staleness.py`'s `_read_brief()`, read `released-at:` off the brief's
...
- [x] 2.1 Confirm `openspec/specs/stale-brief-precheck/spec.md`'s "History Search Is Bounded By
...
- [x] 2.2 Add unit tests in `tests/router/test_check_brief_staleness.py` covering:
...
- [x] 2.3 [e2e] Run `PYTHONPATH=src pytest -q tests/router/test_check_brief_staleness.py`, then
