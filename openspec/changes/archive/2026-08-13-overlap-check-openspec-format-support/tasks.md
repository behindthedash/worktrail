...
- [x] 1.1 In `src/worktrail/router/overlap_check.py`, add a helper that
...
- [x] 1.2 Add extraction for `changes/*/proposal.md`: pull the `##
...
- [x] 3.2 [e2e] Manually verify `worktrail-overlap-check --root
...
- [x] 4.1 [e2e] Run `PYTHONPATH=src pytest -q` — full suite green.
- [x] 4.2 [e2e] Run `PYTHONPATH=src python3 -m
