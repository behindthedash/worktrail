...
<!-- Checkbox-drift remediation (20260823-211154): all 13 items below were implemented
     pre-archive, never ticked. Section 1 (dashboard.py wiring): PR #459. Section 2
     (tests/router/test_dashboard.py) and 3.4: PR #462. Section 3.1/3.2/3.3/3.5 (SKILL.md,
     answer-decision.md, worktrail-help/SKILL.md): PR #460. Verified against current source
     and 12 passing `test_dashboard.py -k decision` tests. -->
