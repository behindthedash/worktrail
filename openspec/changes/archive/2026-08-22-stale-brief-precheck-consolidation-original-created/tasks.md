...
- [x] 1.1 In `consolidate_cluster.py`, add a helper that reads a member's `created:` frontmatter
...
- [x] 2.1 In `check_brief_staleness.py`'s `_read_brief()`, read `original-created:` off the
...
- [x] 3.3 Add unit tests in `tests/router/test_check_brief_staleness.py` covering: `_read_brief()`
