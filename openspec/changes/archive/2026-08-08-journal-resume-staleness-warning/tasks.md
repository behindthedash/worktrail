...
- [x] 1.1 In `src/worktrail/orchestrator/live.py`, add
      ...
      exact message shape).
- [x] 1.2 In `_pipeline_scheduler`'s resume branch (~line 3378, inside `if
      ...
      behavior.
- [x] 1.3 Add `tests/orchestrator/test_live_extras.py` (or a new
...
- [x] 2.1 [e2e] Run `PYTHONPATH=src pytest -q` and `PYTHONPATH=src python3 -m
