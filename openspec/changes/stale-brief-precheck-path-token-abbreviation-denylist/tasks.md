...
- [ ] 2.1 In `tests/router/test_check_brief_staleness.py`, add test coverage asserting that
...
- [ ] 2.2 In the same file, add test coverage asserting that legitimate short-extension
...
- [ ] 3.1 [e2e] Run `PYTHONPATH=src pytest -q` and confirm the full suite passes, including the
