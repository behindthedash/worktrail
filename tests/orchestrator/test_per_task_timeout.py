...
def _fake_spawn_factory():
    ...
    def fake(prompt, worktree, model=None, timeout=None, extra_args=None, resume_session_id=None, fallback_agent=None, log=None):
...
class TestConcurrencyNoBleed(unittest.TestCase):
    ...
    def test_concurrent_calls_each_get_own_timeout(self):
        ...
        def fake_spawn(prompt, worktree, model=None, timeout=None, extra_args=None, resume_session_id=None, fallback_agent=None, log=None):
...
class TestExpiryReportsEffectiveTimeout(unittest.TestCase):
    ...
    def test_expiry_print_contains_effective_timeout_not_run_timeout(self):
        ...
        def raising_spawn(prompt, worktree, model=None, timeout=None, extra_args=None, resume_session_id=None, fallback_agent=None, log=None):
